...
RUN apt-get update && apt-get install -y apt=1.8.2.2 e2fsprogs=1.44.5-1+deb10u3 perl=5.28.1-6+deb10u1 openssl=1.1.1d-0+deb10u4 \
libxml2 libgomp1 tzdata curl=7.64.0-4+deb10u1 libpq5\
